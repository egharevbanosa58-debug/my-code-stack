...
const SkillCard = forwardRef((
    ...
    return (
        <div ref={ref}>
            ...
            className={`flex flex-col gap-4 justify-center p-6 md:p-6 lg:p-8 rounded-2xl border-2 ${ isHovered ? borderColor : "border-slate-400/20"}  bg-white dark:bg-neutral-900/80 hover:shadow-glow transition-all duration-400 hover:-translate-y-3`} style={ isHovered ? { boxShadow: `0 0 20px ${shadow}4d` } : {}}>
